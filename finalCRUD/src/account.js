  ...
  animals.forEach((animal) => {
    let animalLine = $(
      `<div class="displayLine">
          <div class = "info">${animal.animal_name} the ${animal.breed} <img src="./images/${animal.image}"/> </div>
...
const updateHandler = (index) => {
  ...
  $(".save_update").on("click", function () {
    ...
    console.log("Sdasd" + animals[index].image);

    // Update the content of displayLine with the updated info
    displayLine.html(`
      <div class="info">${animals[index].animal_name} the ${animals[index].breed} <img src="./images/${animals[index].image}"/> </div>
...
const createHandler = () => {
  ...
  $(".save_new").on("click", function () {
    ...
    // Use the specific image if it exists, otherwise use the generic image
    let animalLine = $(
      `<div class="displayLine">
          <div class = "info">${newAnimal.animal_name} the ${newAnimal.breed} <img src="./images/${newAnimal.image}"/> </div>
          <div class = "crud_buttons"><button class="view">View</button><button class="update">Update</button><button class="remove">Remove</button></div>
          <div class="showInfo"></div>
       </div>`
    );
